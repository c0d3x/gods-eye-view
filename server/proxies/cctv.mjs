/**
 * The CCTV proxy (/api/cctv): camera sources from the Austin, Caltrans and TfL
 * open-data feeds and the configured source lists, frames and media relayed
 * with public-address checks and size caps, synthetic frames, and the Google
...
// ---------------------------------------------------------------------------
/** The repository root: relative CCTV source files resolve against it. */
...
function loadSourcesFromFile() {
  ...
  const resolved = path.isAbsolute(sourceFile)
    ? sourceFile
    : path.resolve(REPO_ROOT, sourceFile);
  try {
