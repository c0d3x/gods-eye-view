/**
 * Terrain heights proxy: keyless Re:Earth point-height lookups on the
 * ellipsoid, resolved through server/terrainHeightsProxy.mjs and cached.
 */
...
import { readResponseJsonCapped } from '../lib/upstreamBody.mjs';
import {
