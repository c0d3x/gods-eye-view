/**
 * The voice agent's tool schema: the function tools every Realtime session is
 * created with (see openai.mjs). src/voice/gevActions.js carries them out in
 * the browser. The unit suite pins this array, so a change to it is loud.
 */
