...
export class SceneDirector {
  ...
  _initUI() {
    ...
    this._listen(this._sceneDeleteBtn, 'click', () =>
      this._deleteSelectedScene(),
    );
    this._listen(this._sceneCaptureBtn, 'click', () => this.captureShot());
    this._listen(this._sceneUpdateShotBtn, 'click', () =>
  ...
  _setButtons(isRunning) {
    ...
    if (this._sceneDownloadBtn)
      this._sceneDownloadBtn.disabled = !this._lastRunJson;
    if (this._scenePanel)
      this._scenePanel.classList.toggle('running', isRunning);
  }
