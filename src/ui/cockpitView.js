// src/ui/cockpitView.js — Cockpit mode: the first-person camera that rides a
// tracked aircraft, and the cockpit HUD around it (speed and altitude rims,
// compass tape, route, vision modes, the contact card, the signal stream and
// the briefing pages).
//
// StyleManager (src/ui.js) creates one CockpitViewController and owns its
// lifecycle. The controller finds its elements and attaches its DOM and viewer
// listeners in the constructor, and dispose() removes every one of them.
